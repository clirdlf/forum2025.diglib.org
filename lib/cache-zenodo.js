...
const BASE_URL = `https://zenodo.org/api/records?q=communities:dlf-forum+AND+publication_date:%5B${YEAR}-01-01+TO+${YEAR}-12-31%5D&sort=publication_date&size=100`;
